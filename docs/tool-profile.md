...
| `memory_environment_id`, `memory_measurement` | Environment identity and measurement method: `cgroup_v2_memory_current`; the protocol also supports `guest_memtotal_minus_memavailable`, which is not host VM RSS. |
