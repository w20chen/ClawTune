...
export function normalizeSandboxToolParams(
  ...
  toolName: string,
  env: SandboxPathEnv = {
    hostWorkspace: process.env.CLAWTUNE_SANDBOX_HOST_WORKSPACE,
    containerWorkspace: process.env.CLAWTUNE_SANDBOX_CONTAINER_WORKSPACE,
    execWorkdir: process.env.CLAWTUNE_EXEC_WORKDIR,
  }
