...
Start with the [trace measurement and prediction quick guide](docs/tool-profile.md#quick-guide-measurements-and-predictions), then use the same field reference for every stable trace record field, unit, attribution boundary, and unavailable value.
